...
public class SightingsDAO {
	...
	public List<AnnoCount> getAnnoCount(){
		...
		try {
			...
			while(res.next()) {
				AnnoCount a=new AnnoCount(Year.of(res.getInt("anno")), res.getInt("cnt"));
				list.add(a);
	...
	public List<String> getStati(Year anno) {
		String sql="select s.state s " + 
				"from sighting s " + 
				"where country=\"us\" and year(s.datetime)= ? " + 
				"GROUP BY s.state ";
